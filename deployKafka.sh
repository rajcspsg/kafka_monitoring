...
sudo cp /vagrant/kafka_2.12-2.4.0.tgz /home/vagrant/
sudo tar -xvzf kafka_2.12-2.4.0.tgz
sudo rm -rf kafka_2.12-2.4.0.tgz
sudo mv kafka_2.12-2.4.0 kafka
sudo cp /vagrant/jmx_prometheus_javaagent-0.12.0.jar /home/vagrant/
sudo cp /vagrant/kafka-2_0_0.yml /home/vagrant/kafka.yml
cp /vagrant/jolokia-jvm-1.6.2-agent.jar /home/vagrant/jolokia-agent.jar
